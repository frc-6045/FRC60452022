...
// Joysticks
public final Joystick arcadeJoystick = new Joystick(2);
public final Joystick rightTankJoystick = new Joystick(1);
public final Joystick leftTankJoystick = new Joystick(0);
...
arcadeTrigger.whenPressed(new Climb( m_lift ) ,true);
    SmartDashboard.putData("ArcadeTrigger",new Climb( m_lift ) );

final JoystickButton joystickButton2 = new JoystickButton(rightTankJoystick, 1);        
joystickButton2.whenHeld(new Dump( m_dumper ) ,true);
    SmartDashboard.putData("Joystick Button 2",new Dump( m_dumper ) );

final JoystickButton joystickButton1 = new JoystickButton(leftTankJoystick, 1);        
joystickButton1.whenHeld(new IntakeSpin( m_intake ) ,true);
    SmartDashboard.putData("Joystick Button 1",new IntakeSpin( m_intake ) );
